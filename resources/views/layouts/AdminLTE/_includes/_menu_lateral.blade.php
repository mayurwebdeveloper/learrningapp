	...
	<section class="sidebar">
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="{{ Request::segment(1) === 'category' ? 'active' : null }}">
				<a href="{{ route('categories.index') }}" title="Profile"><i class="fa fa-user"></i> <span> CATEGORIES</span></a>
			</li>
			<li class="{{ Request::segment(1) === 'images' ? 'active' : null }}">
				<a href="{{ route('image.index') }}" title="Profile"><i class="fa fa-user"></i> <span>Digital Images</span></a>
			</li>
			<li class="treeview 
